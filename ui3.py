...
class Interface:
    ...
    def create_home_frame(self) -> None:
        ...
        image = Image.open(APP_DIR / "video_games.jpg")
    ...
    def return_graph_results(self, game_name: str, genres: list[str], min_price: int,
        ...
        for game in self.graph.get_games().values():
            if clean_up_line(game.get_game_name()) == game_name:
                ...
                return self.graph.recommended_ten_top_games_with_genres(app_id, genres, min_price, max_price)
        ...
        if possible_games:
            ...
            rec_names, rec_ids = self.graph.recommended_ten_top_games_with_genres(
                self.selected_game.get_app_id(), genres, min_price, max_price
            )
            return self._include_fallback_in_results(rec_names, rec_ids)
...
if __name__ == '__main__':
    ...
    game_data_path = APP_DIR / 'data/filtered_steam_data_4000.csv'
    user_data_path = APP_DIR / 'data/sample_user_data_4000.csv'
    ...
    python_ta.check_all(config={
        ...
        'extra-imports': [
            ...
            'game_user_graph', 'visualization_graph'
        ],
        'allowed-io': [
