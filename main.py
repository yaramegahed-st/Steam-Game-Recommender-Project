...
def run_program() -> None:
    ...
    """
    game_data = game_user_graph.load_game_data('filtered_steam_data_4000.csv')
    user_data = game_user_graph.load_user_data('sample_user_data_4000.csv')
    graph = game_user_graph.load_game_user_graph(game_data, user_data)

    Interface(graph, 'filtered_steam_data_4000.csv')
